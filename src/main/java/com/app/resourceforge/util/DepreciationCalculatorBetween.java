...
public class DepreciationCalculatorBetween {
    ...
    public DepreciationCalculatorBetween(double initialCost, double salvageValue, int usefulLife, LocalDate purchaseDate,LocalDate saleDay) {
    ...
    public List<DepreciationEntry> calculateStraightLineDepreation() {
        ...
        int daysInService = (int) saleDay.toEpochDay() - (int) purchaseDate.toEpochDay();

        int totalDays = daysInService;
        int usedDays = 0;
        int yearPeriod = 1;
