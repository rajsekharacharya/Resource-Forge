...
app.controller("AssetManagementController", function ($scope, $http, $timeout, DTOptionsBuilder) {
  ...
  function _success(response) {
    ...
    $("#Asset_Assign_Customer").modal("hide");
    autoAssetListFetch();
    Swal.fire({
      text: response.data,
      icon: "success",
  ...
  $scope.assetForCustomerAssign = function (id, type) {
    $scope.form = {};
    $scope.form.assetId = id;
    $("#Asset_Assign_Customer").modal("show");

  }

  $scope.assetCustomerSubmit = function () {
    showHideLoad();
    var method = "POST";
    var url = "asset/postCustomerAssign";
    $http({
      method: method,
      url: url,
      data: angular.toJson($scope.form),
  ...
  $scope.assetCustomerWork = function (id, type) {
    showHideLoad();
    $http({
      method: "PUT",
      params: { id: id, type: type },
      url: "asset/assetCustomerWork",
      headers: {
        "Content-Type": "application/json",
      },
      transformResponse: angular.identity,
